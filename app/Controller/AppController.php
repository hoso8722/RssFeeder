			...
			switch($sw)
			{
				...
				case 1:
					if(isset($cookieSet['last']))
					{
						...
						{
							case 0:$lastNum = 50;break;
							case 1:$lastNum = 100;break;
							case 2:$lastNum = 150;break;
							case 3:$lastNum = 200;break;
							case 4:$lastNum = 250;break;
							case 5:$lastNum = 300;break;
							default: $lastNum = 100;
						}
					}else{
						$lastNum = 100;
				...
				case 2:
					if(isset($cookieSet['trand']))
					{
						...
						{
							case 0:$trandNum = 50;break;
							case 1:$trandNum = 100;break;
							case 2:$trandNum = 150;break;
							case 3:$trandNum = 200;break;
							case 4:$trandNum = 250;break;
							case 5:$trandNum = 300;break;
							default: $trandNum = 100;
						}
					}else{
						$trandNum = 100;
					}
				...
				case 3:
					if(isset($cookieSet['disprss']))
					{
						...
						{
							case 0:$disprss = 2;break;
							case 1:$disprss = 4;break;
							case 2:$disprss = 6;break;
							case 3:$disprss = 8;break;
							case 4:$disprss = 10;break;
							case 5:$disprss = 15;break;
							case 6:$disprss = 20;break;
							case 7:$disprss = 25;break;
							case 8:$disprss = 30;break;
							default: $disprss = 4;
						}
					}else{
						$disprss = 4;
				...
				case 4:
					if(isset($cookieSet['ocmenu']))
					{
						...
						{
							case 0:$ocmenu = 0;break;
							case 1:$ocmenu = 1;break;
							default: $ocmenu = 1;
						}
					}else{
						$ocmenu = 1;
