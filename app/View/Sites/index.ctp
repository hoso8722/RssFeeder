<div class="span9">
    <ul id="myTab" class="nav nav-tabs">
        <li class="active"><a href="#home" data-toggle="tab">
                <p class="brand"><i class="icon-play-circle"></i>ブログ一覧/設定</p>
            </a></li>

        <li><a class="notvisited" href="#profile" data-toggle="tab">
                <p class="brand"><i class="icon-play-circle"></i>表示設定</p>
            </a></li>
    </ul>
