...
<li>
<button id='liDate' class="btn btn-small <?php if($chTable[0]==0){echo 'btn-inverse">日時を非表示</button>';}else{echo 'btn-info">日時を表示</button>';} ?>
</li>
...
<li><button id='liHit' class="btn  btn-small <?php if($chTable[2]==0){echo 'btn-inverse">HITバーを非表示</button>';}else{echo 'btn-info">HITバーを表示</button>';} ?></li>
...
<li><button id='liHitHead' class="btn  btn-small <?php if($chTable[5]>=1){echo 'btn-info">記事にHIT数を表示</button>';}else{echo 'btn-inverse">記事にHIT数を非表示</button>';}?></li>
...
<li><button id='liFilter' class="btn  btn-small <?php if($chTable[7]==0){echo 'btn-iverse">フィルター列を非表示</button>';}else{echo 'btn-info">フィルター列を表示</button>';} ?></li>
